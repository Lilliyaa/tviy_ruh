...
Widget buildRoundedCard(BuildContext context, IconData icon, String ttl,
    String txt, String all, String real, String percent) {
  return Card(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(ttl, style: Theme.of(context).textTheme.headline2),
                  ],
                ),
                SizedBox(
                  width: 50,
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(txt, style: Theme.of(context).textTheme.headline3),
                Text(real + "/" + all,
